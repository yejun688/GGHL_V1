...
class DOTA:
    def __init__(self, basepath):
        ...
        self.labelpath = os.path.join(basepath, 'dota_ann')
        # self.imagepath = os.path.join(basepath, 'images')
        self.labelpath = os.path.join(basepath, 'image')
...
if __name__ == '__main__':
    examplesplit = DOTA(basepath='../../../datasets/slam_parkingslot/new_data/')
    imgids = examplesplit.getImgIds(catNms=['直行'])
